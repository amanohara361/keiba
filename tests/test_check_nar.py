...
# 単勝は出走全頭ぶん要る。bet_builder が Harville で券種ごとの的中率を出すのに
# 勝率分布が必要なため（2026-08-26）。1頭ぶんしか無いと分布が作れず見送りになる。
ODDS = ODDS_HEADER + '\n' + '\n'.join([
    '笠松,20260812,11,単勝,1,,,3.0,,1',
    '笠松,20260812,11,単勝,2,,,5.0,,2',
    '笠松,20260812,11,単勝,3,,,9.0,,3',
    '笠松,20260812,11,単勝,4,,,20.0,,4',
...
def _sheet():
    return BetSheet(date=date(2026, 8, 12), races=[RaceBets(
        ...
        win_probabilities={1: 0.40, 2: 0.22, 3: 0.14},
    )])
